/* API endpoints*/
// base URL: https://exercisedb.p.rapidapi.com/exercises
...
// List exercises by body part (search below is for chest)
// endpoint: /bodyPart/{bodypart}
...
// Search for exercise by target muscle
// endpoint: /target/{targetMuscle}
const targetResult = [
    {
        "bodyPart": "chest",
        "equipment": "body weight",
...
// endpoint: /equipment/{equipmentType}
...
fsPromises.writeFile('jsonstring.json', JSON.stringify(allExercises)).then(() => { console.log('JSON saved');}).catch(er => {console.log(er);});